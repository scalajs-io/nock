...
lazy val publishingSettings = Seq(
  ...
  pomExtra :=
    <url>https://github.com/scalajs-io/nock</url>
      <licenses>
        <license>
      ...
      <scm>
        <connection>scm:git:github.com/scalajs-io/nock.git</connection>
        <developerConnection>scm:git:git@github.com:scalajs-io/nock.git</developerConnection>
        <url>github.com/scalajs-io/nock.git</url>
      </scm>
      <developers>
        <developer>
          <id>ldaniels528</id>
